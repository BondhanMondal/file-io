<?php
	...
	if($_SERVER['REQUEST_METHOD'] === "POST")
	{
		...
		if(empty($fileData)) {
		$data[] = array("firstname" => $firstName, "lastname" => $lastName, "gender" => $gender, "dob" => $dob, "religion" =>
			$religion, "present_address" => $present_address, "parmanent_address" => $parmanent_address, "phone" => $phone, "email" => $email, "website" => $website, "username" => $username, "password" => $password);
		}
		else {
		$data[] = json_decode($fileData);
		array_push($data, array("firstname" => $firstName, "lastname" => $lastName, "gender" => $gender, "dob" => $dob, "religion" => $religion, "present_address" => $present_address, "parmanent_address" => $parmanent_address, "phone" => $phone, "email" => $email, "website" => $website, "username" => $username, "password" => $password));
		}
